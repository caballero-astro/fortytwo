...
output_dir='MC_6PSR_CURN-GWB_PL_psh0_fbm1_GlEf' # Set output directory name (rootpath subdirectory) for all results
...
GEfL,GEfU=0.3,3 # (linear) Global EFAC value (lower,upper).
